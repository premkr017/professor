    ...
    <div class="card" style="max-width:700px">
        ...
        <form method="POST" action="{{ route('categories.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" placeholder="e.g. Grocery, Salary, Petrol" required>
                @error('name')
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="icon" id="icon" class="form-control" value="{{ old('icon', '🏷️') }}" placeholder="🏷️">
                    @error('icon')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="color" name="color" id="color" class="form-control" value="{{ old('color', '#6b7280') }}">
                    @error('color')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
